        ...
        <>
            {
                (alerta.error)
                    ? 
                    <div className="bg-red-100 border-t-4 border-red-500 rounded text-red-700 px-4 py-3 shadow-md" role="alert">
                        <div className="flex justify-center items-center">
                            ...
                            <div>
                                <p className="font-bold">{alerta.msg}</p>
                                {/* <p class="text-sm">Make sure you know how these changes affect you.</p> */}
                            </div>
                        </div>
                    </div>
                    :
                    <div className="bg-teal-100 border-t-4 border-teal-500 rounded text-teal-900 px-4 py-3 shadow-md" role="alert">
                        <div className="flex justify-center items-center">
